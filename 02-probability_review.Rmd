...
The required mathematical background is summarized in the Prerequisites section of Chapter \@ref(intro). In this chapter, we identify common notation and review the most important material from each.
...
1. Verify that the mean and variance of the $\mathcal{N}(\vec{\mu},{\bf \Sigma})$ distribution are indeed $\vec{\mu},\,{\bf \Sigma}$ respectively by computing the integrals directly.

...
Calculate the degree matrix $\mathbf{D}$, which is a diagonal matrix where each diagonal element $D_{ii}$ is the sum of the weights of the edges connected to node $i$.

## Hierarchical Clustering {#sec-hierarchical-clustering}
...
In the figure below, samples 8 and 15 are merged into a cluster at height $\approx 0.5$ indicating they have an original dissimilarity (Euclidean distance in this case) of 0.5. Sample 4 is then merged into the cluster with samples 8 and 15 at height $\approx 0.75$, indicating the dissimilarity of sample 4 with the cluster of samples 8 and 15.

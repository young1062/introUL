...
$$\text{argmin}_{Y \in \mathbb{R}^{N\times k}} \| B - YY^T\|_F$$
...
"There is a duality between a principals components analysis and classical MDS where dissimilarities are given by Euclidean distance"[@cox2000multidimensional].
...
```{r, fig.cap="Sammon stress for Global Cities Data", echo = FALSE}
t <- stress <- 1:8
for (j in t){

...
```{r keras_mnist_pca, echo = FALSE, cache = TRUE, fig.align='center',fig.cap="2D Representation of MNIST via PCA",out.width="80%",out.height="auto"}
require("keras")
mnist <- dataset_mnist()
...
p <- ggplot(scores, aes(x = PC1, y = PC2, color = as.factor(labels_train))) +

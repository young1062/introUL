...
```{r helix-examples, echo = FALSE, fig.cap = "Recovered latent space vs original coordinates"}
...
knitr::include_graphics("images/Helix-DR-comparison.png")
```
...
```{r swiss-examples, echo = FALSE, fig.cap = "Recovered latent space vs original coordinates"}
...
#      col = myColorRamp(c("red","purple","blue","green","yellow"), swiss_color ),
#      main = "Autoencoder", xlab = "",ylab = "")
knitr::include_graphics("images/Swiss-DR-comparison.png")
```

#### Folded Washer

```{r fold-washer-examples, echo = FALSE, fig.cap = "Recovered latent space vs original coordinates"}
...
#      col = myColorRamp(c("red","purple","blue","green","yellow"), washer3[,1] ),
#      main = "Autoencoder", xlab = "",ylab = "")
knitr::include_graphics("images/Folded-Washer-DR-Comparison.png")
```

#### Rolled Washer

```{r roll-washer-examples, echo = FALSE, fig.cap = "Recovered latent space vs original coordinates"}
...
#      col = myColorRamp(c("red","purple","blue","green","yellow"), washer.swiss[,1] ),
#      main = "Autoencoder", xlab = "",ylab = "")
knitr::include_graphics("images/Rolled-Washer-DR-Comparison.png")
```